...
# turn off financial reporting, which currently expects to find LOAD_ZONES in Switch-Electricity
...
def define_components(m):
    ...
    ## BuildDirectionalGl: how much gas line capacity in EACH DIRECTION (MMBtu) installed on a corridor in a given build year.
    ...
    )  # should be 0.96 to account for this storage fuel loss.
